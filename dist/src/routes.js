...
const personalisation_controller_1 = require("./controllers/personalisation.controller");
function routes(app, db) {
    const userController = new user_controller_1.UserController(db);
    const chatroomController = new chatroom_controller_1.ChatroomController(db);
    const messageController = new message_controller_1.MessageController(db);
    const userPersonalisationController = new personalisation_controller_1.UserPersonalisationController(db);
    /**
